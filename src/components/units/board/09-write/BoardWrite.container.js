...
export default function BoardWrite(props){
    ...
    const onClickSubmit = async() =>{
        ...
        router.push(`/section09-board-edit/09-03-boards/${result.data.createBoard.number}`)
    }
    ...
    const onClickUpdate = async() =>{
        ...
        router.push(`/section09-board-edit/09-03-boards/${result.data.updateBoard.number}`)
